...
@foreach ($product as $i)
    <tr>
        ...
        <td class="image-prod"><img class="img-fluid" src="{{ $message->embed(public_path() . "/images/" . $i->attributes->cover_image) }}" alt="Colorlib Template" style="width:100px;height:100px"></td>
