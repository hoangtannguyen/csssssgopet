...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">Nguyên Hoàng</a>
            </div>
        </div>
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item has-treeview">
                    <a href="{{ route('category.index') }}" class="nav-link">
                        <i class='fas fa-dragon' style='font-size:24px'></i>
                        <p>
                           Loại sản phẩm
                ...
                <li class="nav-item has-treeview">
                    <a href="{{ route('a.index') }}" class="nav-link">
                        <i class='fas fa-feather' style='font-size:24px'></i>
                        <p>
                            Kiểu phụ kiện
                ...
                <li class="nav-item has-treeview">
                    <a href="{{ route('type.index') }}" class="nav-link">
                        <i class='fas fa-otter' style='font-size:24px'></i>
                        <p>
                            Kiểu bò sát
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{route('billd.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item has-treeview">
                    ...
                    {{-- <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('acce.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Pet Accessories</p>
                            </a>
                        </li>
